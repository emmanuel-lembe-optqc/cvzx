...
def run_graphical_tests():  # noqa: PLR0914, PLR0915
    ...
    composition_chain_1 = q_spider_5x5.compose(
        TensorDiagram([fourier_squared, fourier, fourier_squared, inverse_fourier, fourier])
    )
    tensor_chain = TensorDiagram([swap, swap, fourier])
    composition_chain_1 = q_spider_5x5.compose(composition_chain_1)
    ...
    tensor_block_6 = q_spider_4x3.tensor(CompositionDiagram([q_spider_5x5, p_spider_5x5, q_spider_5x5]))
    ...
    contracted_from_tensor_2 = ContractedDiagram(
        q_spider_5x5, tensor_block_6, [0, 1, 4], [1, 2, 3], [0, 1, 2], [1, 2, 4]
    )
    ...
    # ========================================================================
    # 14. Contracted diagrams composed of Contracted Diagrams
    # ========================================================================

    inner_contracted1 = ContractedDiagram(
        TensorDiagram([q_spider_1x1, p_spider_1x1, q_spider_1x1, p_spider_1x1]), swap, I1=[0], I2=[0], J1=[1], J2=[0]
    )
    inner_contracted2 = ContractedDiagram(
        TensorDiagram([q_spider_1x1, p_spider_1x1, p_spider_2x2]),
        q_spider_2x2,
        I1=[1],
        I2=[1],
        J1=[0],
    ...
    outer_contracted1 = ContractedDiagram(
        inner_contracted1, TensorDiagram([p_spider_2x2, q_spider_2x2]), I1=[1, 3], I2=[0, 2], J1=[0, 1], J2=[1, 2]
    )
    save_and_close(
        outer_contracted1,
        "Contracted_diagram_composed_of_Contracted_1.png",
        "Contracted diagram composed of Contracted Diagrams 1",
    )
    outer_contracted2 = ContractedDiagram(
        inner_contracted1, inner_contracted2, I1=[1, 3], I2=[0, 2], J1=[0, 1], J2=[1, 2]
    )
    save_and_close(
        outer_contracted2,
        "Contracted_diagram_composed_of_Contracted_2.png",
