"""Unit tests for the fusion rewrite rule.

These tests verify the FusionRule implementation, including matching,
application, and nested structures. Both Q-spider and P-spider fusion are covered.
"""
...
from mqc3.zx.rewrite_rules import FusionRule


class TestFusionRule(unittest.TestCase):
    """Test suite for FusionRule."""
    ...
    def test_apply_single_with_no_match(self):
    ...
    def test_apply_single_with_deeply_nested(self):
        """Test using kept_first_inputs and kept_second_inputs."""
        contracted = ContractedDiagram(self.q1, self.q2, I1=[0], I2=[0], J1=[], J2=[])
        tensor = TensorDiagram([self.fourier, contracted])
        comp = CompositionDiagram([tensor, self.swap])
        tensor2 = TensorDiagram([comp, self.ph_rot])
    ...
    def test_fusion_multiple_times(self):
        ...
        inner_contracted = ContractedDiagram(self.q1, self.q2, I1=[0], I2=[0], J1=[], J2=[])
        outer_contracted = ContractedDiagram(inner_contracted, self.q_2x2, I1=[0], I2=[0], J1=[], J2=[])

        # Apply once - fuses inner pair
        result1 = self.rule.apply_rule(outer_contracted)
